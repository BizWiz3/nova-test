...
# 1. Install system dependencies (Added libstdc++6 here)
RUN apt-get update && \
    apt-get install -y curl unzip ca-certificates libssl-dev git libstdc++6 && \
...
# 8. Set the environment variable for the port
# ENV PORT=8080
EXPOSE 8080
